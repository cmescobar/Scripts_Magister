...
def segnet_based_6_7(input_shape, padding_value, output_number=2, name=None):
    '''CNN basada en arquitectura encoder-decoder basada en SegNet.
    Se utiliza el mismo canal para todas las envolventes.
    ...
    layer_params_1 = {'filters': N_c, 'kernel_size': H_l, 'padding': 'same',
                      'kernel_initializer': 'he_normal', 'name': 'enc1'}
    x_enc1 = _encoding_layer(x_in, n_layers_conv=2, layer_params=layer_params_1)
    ...
    # Definición de la capa de salida
    x_out = tf.keras.layers.Dense(output_number, activation='softmax', 
                                  kernel_initializer='he_normal',
                                  name='softmax_out')(x_dec1)
...
def segnet_based_8_x(input_shape, padding_value, output_number=2, 
                     name=None):
    '''CNN basada en arquitectura encoder-decoder basada en SegNet.
    Se utiliza el mismo canal para todas las envolventes.
    ...
    [2] Ye, J. C., & Sung, W. K. (2019). Understanding geometry of 
        encoder-decoder CNNs. arXiv preprint arXiv:1901.07647.
    '''
    return segnet_based_6_7(input_shape, padding_value, 
...
def definitive_segnet_based(input_shape, padding_value, output_number=2, 
                            name=None):
    '''CNN basada en arquitectura encoder-decoder basada en SegNet.
    Se utiliza el mismo canal para todas las envolventes.
    ...
    [2] Ye, J. C., & Sung, W. K. (2019). Understanding geometry of 
        encoder-decoder CNNs. arXiv preprint arXiv:1901.07647.
    '''
    return segnet_based_8_x(input_shape, padding_value, 
                            output_number=output_number, 
                            name=name)


def definitive_segnet_based_2(input_shape, output_number=1, 
                              name=None):
    '''CNN basada en arquitectura encoder-decoder basada en SegNet.
    Se utiliza el mismo canal para todas las envolventes.
    ...
    # Definición de la capa de salida
    x_out = tf.keras.layers.Dense(output_number, activation='sigmoid', 
                                  kernel_initializer='he_normal',
                                  name='softmax_out')(x_dec1)
