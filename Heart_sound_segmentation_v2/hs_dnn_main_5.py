...
from paper_DNN_models import cnn_dnn_1
...
open('Models/Last_model_reg.txt', 'w', encoding='utf8').close()
...
for epoch in range(epochs):
    ...
    with open('Models/Last_model_reg.txt', 'a', encoding='utf8') as file:
