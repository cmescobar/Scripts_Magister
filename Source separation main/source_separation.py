...
def _nmf_decomposition_denoising(signal_in, samplerate, n_components=2, N=2048, noverlap=1024, 
                                iter_prom=1, padding=0, repeat=0, window='hann', whole=False, 
                                alpha_wiener=1, filter_out='wiener', init='random', solver='cd', 
                                beta=2, tol=1e-4, max_iter=200, alpha_nmf=0, l1_ratio=0,
...
def _nmf_decomposition_bandlimited(signal_in, samplerate, n_components=2, N=2048, noverlap=1024, 
                                  iter_prom=1, padding=0, repeat=0, window='hann', whole=False, 
                                  alpha_wiener=1, filter_out='wiener', init='random', solver='cd', 
                                  beta=2, tol=1e-4, max_iter=200, alpha_nmf=0, l1_ratio=0,
                                  random_state=None, W_0=None, H_0=None, same_outshape=True,
...
def _nmf_decomposition_k_more(signal_in, samplerate, n_components=2, N=2048, noverlap=1024, 
                             iter_prom=1, padding=0, repeat=0, window='hann', whole=False, 
                             alpha_wiener=1, filter_out='wiener', init='random', solver='cd', 
                             beta=2, tol=1e-4, max_iter=200, alpha_nmf=0, l1_ratio=0,
                             random_state=None, W_0=None, H_0=None, same_outshape=True,
